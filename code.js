...
const WEB_SMALL = "9b236c863ebae21888bf89367425a58ea1a02037";
const WEB_MEDIUM = "064634ac23628242c43976a47073f2c079877256";
const WEB_LARGE = "6faf59b0f39b5f06f5eba503b2e29e200bc89223";
const WEB_XLARGE = "0a3bea8cf4caed89022e834395a09472e9a444a9";
const WEB_XXLARGE = "796cd4a2397a3023a186377878859d3b2d7b278c";
const WEB_XXXLARGE = "4774b7bae373d56267eb8d92f73b7ec415520bba";
const WEB_SMALL_BOLD = "b98998a87a0771937853b4697d478031a12e8dba";
const WEB_MEDIUM_BOLD = "f3d62f8fbb037dce354f5a6959b73ffa03d5b153";
const WEB_LARGE_BOLD = "e63cc47c6222f14739722def4ed9aa9298394d8c";
const WEB_XLARGE_BOLD = "8e701844cdbc3637fd7a9a9efbd4a8c1f9b276a2";
const WEB_XXLARGE_BOLD = "dcea1aefb87ac17136f929a544087392b69669f0";
const WEB_XXXLARGE_BOLD = "1bf91b9055090d99eeb248f12615b26c4768f529";
const IOS14_SMALL = "2629d79d087fbe03434d7ae180456796d6e1a3d2"; //Caption 1
const IOS14_MEDIUM = "ccbd2b00d262f548276bd22147bed1596dd6771f"; //Subhead
const IOS14_LARGE = "376bf391eb763ee87b3906f26b3a0c3dfca0ddd0"; //Body
const IOS14_XLARGE = "0250ab0a8a13ce37a6bad51be9d753b9dfdf4787"; //Title 2
const IOS14_XXLARGE = "5020a1bdf48137ba69a21134c8445e7832d65ea9"; //Title 1
const IOS14_XXXLARGE = "e867cd04887e0e54b3c9eade9fd7e40e61ffda12"; //Large Title
const IOS14_SMALL_BOLD = "6ffc4cd6b84a26e25e6da606f5a5416b8b80beda";
const IOS14_MEDIUM_BOLD = "c693f2b16ad2727b668773ed6866529e856bb182";
const IOS14_LARGE_BOLD = "e9fb8165d42eae073e850d8005e20472a1295c26";
const IOS14_XLARGE_BOLD = "a9b69053199d2b0f3c60bf047e2eea68e44bfc0d";
const IOS14_XXLARGE_BOLD = "de4407ec3146bf25cd0f7fb9fe69640346835865";
const IOS14_XXXLARGE_BOLD = "0519019a6f20964f4e54887d5b25cdb23708d22f";
const IOS15_SMALL = "9fb20e130651023a2fb9caece0c7d3d6eb315d57"; //Caption 1
const IOS15_MEDIUM = "5110a8afcfc58a0127a8bd0be7e31f2b8b206e66"; //Subhead
const IOS15_LARGE = "f37f65a1bf4225f6b1675f44c5f0e8320a96dc2e"; //Body
const IOS15_XLARGE = "60d6eb65314a2d8f99e84621b847689c5f0178e6"; //Title 2
const IOS15_XXLARGE = "63fb0b2f86c3706c47f1d6111324bc2c0e4f502e"; //Title 1
const IOS15_XXXLARGE = "24aeb16a275fa6deb4ac3d5eff669242fc27c3c9"; //Large Title
const IOS15_SMALL_BOLD = "fca3f9eeb9fd636bf6475582e185b687f3203152";
const IOS15_MEDIUM_BOLD = "4257384f1d426ba51133e9e621dc00753e3a6b19";
const IOS15_LARGE_BOLD = "497bf40c99168146ecc39dd30ef747932bdae5a8";
                ...
                try {
                    switch (style.key) {
                        ...
                        case IOS16_XXXLARGE:
                            if (figma.command == "ios") {
                                //...swap to 'Large Title'.
                                yield swapStyle(IOS16_XXXLARGE);
                            }
                            else if (figma.command == "android") {
                                //...swap to 'Headline 4'.
                        ...
                        case IOS16_SMALL_BOLD:
                            if (figma.command == "ios") {
                                //...swap to 'Caption 1'.
                                yield swapStyle(IOS16_SMALL_BOLD);
                            }
                            else if (figma.command == "android") {
                                //...swap to '_'.
                                yield swapStyle(MD3_SMALL);
                        ...
                        case IOS16_MEDIUM_BOLD:
                            if (figma.command == "ios") {
                                //...swap to 'Subhead'.
                                yield swapStyle(IOS16_MEDIUM_BOLD);
                            }
                            else if (figma.command == "android") {
                                //...swap to '_'.
                                yield swapStyle(MD3_MEDIUM);
                        ...
                        case IOS16_LARGE_BOLD:
                            if (figma.command == "ios") {
                                //...swap to 'Body'.
                                yield swapStyle(IOS16_LARGE_BOLD);
                            }
                            else if (figma.command == "android") {
                                //...swap to '_'.
                                yield swapStyle(MD3_LARGE);
                        ...
                        case IOS16_XLARGE_BOLD:
                            if (figma.command == "ios") {
                                //...swap to 'Title 2'.
                                yield swapStyle(IOS16_XLARGE_BOLD);
                            }
                            else if (figma.command == "android") {
                                //...swap to '_'.
                                yield swapStyle(MD3_XLARGE);
                        ...
                        case IOS16_XXLARGE_BOLD:
                            if (figma.command == "ios") {
                                //...swap to 'Title 1'.
                                yield swapStyle(IOS16_XXLARGE_BOLD);
                            }
                            else if (figma.command == "android") {
                                //...swap to '_'.
                                yield swapStyle(MD3_XXLARGE);
                        ...
                        case IOS16_XXXLARGE_BOLD:
                            if (figma.command == "ios") {
                                //...swap to 'Large Title'.
                                yield swapStyle(IOS16_XXXLARGE_BOLD);
                            }
                            else if (figma.command == "android") {
                                //...swap to '_'.
                                yield swapStyle(MD3_XXXLARGE);
